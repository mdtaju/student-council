...
import CustomNote from "../ApplicationRequirement/CustomNote";
...
const ApplicationRequirement = ({ requirements, setRequirements }) => {
  ...
  return (
    <div className="col-span-3">
      ...
      {requirements?.map((req, i) => (
        <div
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 my-3">
            ...
            <div>
              <h1 className="text-sm font-medium">Access Type:</h1>
              <p className="text-normal font-semibold text-gray-700">
                {req.access_type}
              </p>
            </div>
      ...
      {appRequirement && (
        <div className="md:grid md:grid-cols-2 space-y-3 md:space-y-0 gap-4 my-4">
